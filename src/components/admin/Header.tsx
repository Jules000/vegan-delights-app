      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3 cursor-pointer group">
          <div className="text-right hidden md:block">
            <p className="text-sm font-bold leading-none text-admin-forest group-hover:text-admin-primary transition-colors">Alex Rivera</p>
            <p className="text-[10px] text-admin-forest/40 font-bold uppercase tracking-tighter">Gérant Boutique</p>
          </div>
          <div className="size-10 rounded-full border-2 border-admin-primary/20 p-0.5 overflow-hidden">
            <img alt="Admin user profile headshot" className="w-full h-full object-cover rounded-full bg-admin-sage" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBp3LAHq2FaO04lq_-rt5XIr2iQ4YnDZlBfRQSRIskAeMHhaC6H6MAt7YfBHaDFJYUpAxVPCxAAaAHthlj4UYi1smRbdHYZh4_XbxwioUwupA-wJ6uUkuR-vRoMaB8dnv4S__veQjYA-wur2ENSKqVtp4rkWxnLE6fSxp6ckCV6uyFiG6aWABBJOJsVjGyKW0i_-_ns5vo-hBseaHc1JwGmQmlZdhEMZBc9fb0FGt_yC-KsHtTxCjthqJt9aSieCzTfUNC887wLmxKm"/>
          </div>
        </div>
      </div>
    </header>
